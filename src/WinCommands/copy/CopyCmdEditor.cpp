...
int CopyCmdEditor::getProperty(int propertyId, QVariant &out_property)
{
    int code = 0;
...
int CopyCmdEditor::setProperty(int propertyId, const QVariant &property)
{
    return 0;
}
...
QString CopyCmdEditor::getCmdString()
{
    ...
    if (options.isEmpty())
    {
        cmd = QString("%1 %2 \"%3\"").arg(cmd_name,
            srcFilepath, destFilepath);
    }
    else
    {
        cmd = QString("%1 %2 %3 \"%4\"").arg(cmd_name,
