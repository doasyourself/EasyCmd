...
int TasklistCmdEditor::getProperty(int propertyId, QVariant &out_property)
{
    int code = 0;
...
int TasklistCmdEditor::setProperty(int propertyId, const QVariant &property)
{
    return 0;
}
...
void TasklistCmdEditor::initFilters()
{
    ...
    // 监听修改操作
    connect(ui->comboBox_op_status, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_imageName, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_pid, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_session, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_sessionName, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_cpuTime, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_memusage, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_userName, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_service, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_windowTitle, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->comboBox_op_module, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    ...
    /************* 筛选值编辑器 ****************/
    // 监听修改操作
    connect(ui->comboBox_fiValue_status, QOverload<int>::of(&QComboBox::currentIndexChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_imageName, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_pid, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_session, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_sessionName, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->timeEdit_fiValue_cpuTime, &QTimeEdit::timeChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->spinBox_fiValue_memUsage, QOverload<int>::of(&QSpinBox::valueChanged), this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_userName, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_service, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_windowTitle, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
    connect(ui->lineEdit_fiValue_module, &QLineEdit::textChanged, this, &TasklistCmdEditor::slot_checkBox_clicked);
...
void TasklistCmdEditor::slot_checkBox_clicked()
{
    emit sigNotify(SID_MODIFIED, QVariantHash());
}
