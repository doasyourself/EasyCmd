    ...
    m_command(command)
{
    ...
    connect(ui->chkbox_option_p, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_q, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_w, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_d, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);

    connect(ui->groupBox_option_a, &QGroupBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_d, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_h, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_s, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_l, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_d, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_r, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_a, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_a_i, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);

    connect(ui->groupBox_option_o, &QGroupBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_o_n, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_o_e, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_o_g, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_o_s, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_o_d, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_o_reverse, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);

    connect(ui->groupBox_option_t, &QGroupBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_t_c, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_t_a, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_t_w, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);

    connect(ui->chkbox_option_s, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_b, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_l, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_n, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_x, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_c, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_4, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_r, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
    connect(ui->chkbox_option_help, &QCheckBox::toggled, this, &DirCmdEditor::sigModified);
}
